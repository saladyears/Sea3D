...
/////////////////////////////////////////////////////////////////////////////
// creates the Seafarers: Oceans (V) map
/////////////////////////////////////////////////////////////////////////////
void CMapDatabase::createOceansV(CS3DMap *pMap)
{
	//identifier
	pMap->m_uiID = MAP_SEA_OCEANS_V;
	...
	pMap->m_iLandTiles = 31;
	pMap->m_iSeaTiles = 63;
	pMap->m_iHiddenTiles = 26;
	...
	pMap->m_iHiddenRes[RES_OCEAN] = 15;
	...
	pMap->m_nHiddenChit[9] = 2;
	pMap->m_nHiddenChit[10] = 0;

	//create the map
	createMap(MAP_BORDERS_XX_XX, pMap, coordsOceansV);
...
/////////////////////////////////////////////////////////////////////////////
// Oceans (V) coordinates
/////////////////////////////////////////////////////////////////////////////
void CMapDatabase::coordsOceansV(int iIndex, CMapPiece *pPiece)
{
	//set the tile type
	switch(iIndex)
	{
	...
	case 57: case 58: case 68: case 74: case 82:
		//set land type
